...
<div class="container">
    ...
    <form style="width: 600px; margin: auto"
          action="/students?action=update&&id=${students.id}" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="age" name="age"
                   placeholder="Enter age" value="${students.age}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="classes" name="classes"
                ...
                <c:forEach items="${classes}" var="c">
                    <option value="${c.id}"  ${students.getClasses().getId() == c.id ? 'selected' : ''}>
                            ${c.name}
                    </option>
                </c:forEach>
            </select>
